...
#'
#' \if{html}{\figure{qrcdifproporciones.png}{options: style="width: 25\%;"}}
...
#'
#' \if{html}{\figure{cdifpromuestra.png}{width = 480px}}
...
#'
#' \if{html}{\figure{cproponderacion.png}{width = 400px}}
#' \if{latex}{\figure{cproponderacion.png}{options: width=6cm}}
#'
#' y el estadístico resulta:
#'
#' \if{html}{\figure{cdifpropond.png}{width = 480px}}
