...
#'
#' \if{html}{\figure{qrcmedia.png}{options: style="width: 25\%;" alt="Figure: qricvarianza.png"}}
...
#'
#' \if{html}{\figure{cmediavarcon.png}{options: style="width: 30\%;" alt="Figure: cmediavarcon.png"}}
...
#'
#' \if{html}{\figure{cmediavardescmuestra.png}{options: style="width: 30\%;" alt="Figure: cmediavardescmuestra.png"}}
#' \if{latex}{\figure{cmediavardescmuestra.png}{options: width=3cm}}
#'
#' (2.2) usando la cuasi-varianza muestral
#'
#' \if{html}{\figure{cmediavardesccuasi.png}{options: style="width: 30\%;" alt="Figure: cmediavardesccuasi.png"}}
