...
#'
#' \if{html}{\figure{qricvarianza.png}{options: style="width: 25\%;"}}
...
#'
#' \if{html}{\figure{icvarianzamedcon.png}{width = 200px}}
...
#'
#' \if{html}{\figure{icvarianzameddescmuestra.png}{width = 200px}}
#' \if{latex}{\figure{icvarianzameddescmuestra.png}{options: width=6cm}}
#'
#' Con la cuasivarianza muestral:
#'
#' \if{html}{\figure{icvarianzameddesccuasi.png}{width = 200px}}
