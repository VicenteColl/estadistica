...
#' @param var_muestra Es un carácter. Indica si se utilizará la varianza muestral (por defecto, var_muestra = "muestral") o la cuasivarianza muestral (es este caso, cambiar var_muestra = "cuasi").
