...
convergencia.varianza <- function(){
  ...
  message("Generando animaci\u00f3n... Cuando se cargue haz clic en el bot\u00f3n: Play")

  message("Convergencia: Observa \u00f3mo la diferencia entre varianza muestral y cuasivarianza muestral disminuye a medida que aumenta el tama\u00F1o de la muestra.")

  message("Cu\u00e1nto mayor sea el tama\u00F1o de la muestra menor ser\u00e1 la diferencia entre varianza y cuasivarianza muestral")
...
# convergencia: diferencia menor o igual a 1
  df$diferencia <- abs(
    ...
    layout(
      ...
      title = list(
        ...
        text = paste0(
          ...
          "<br><sup>",
          "Los puntos se vuelven verdes cuando la diferencia menor o igual a 1",
          "</sup>"
        ),
