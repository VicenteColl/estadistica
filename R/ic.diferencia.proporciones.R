...
#'
#' \if{html}{\figure{qricdiferenciaproporciones.png}{options: style="width: 25\%;" alt="qricdiferenciaproporciones.png"}}
...
#'
#' \if{html}{\figure{icdifproporciones.png}{options: style="width: 65\%;" alt="icdifproporciones.png"}}
