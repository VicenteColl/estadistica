...
#' \if{latex}{\figure{iccocientevarmuestra2.png}{options: scale=1.1}}
#'
...
#' \if{latex}{\figure{iccocientevarcuasi2.png}{options: scale=.8}}
#'
#' @references
